...
def test_adjustment_transaction_creation_logic(mock_db_session):
    ...
    mock_account_service.accounts[account_id] = mock_account
    ...
    adjustment_service.account_service = cast(AccountService, mock_account_service) # Inject the mock account service
...
def test_adjustment_transaction_creation_negative_difference(mock_db_session):
    ...
    adjustment_service = ManualBalanceAdjustmentService(mock_db_session)
    adjustment_service.account_service = cast(AccountService, mock_account_service)
